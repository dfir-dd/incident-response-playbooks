...
Pause (not shutdown) Virtual Machines that show signs of an active infection. This way they may be analyzed later without potential data loss.
...
Decide whether to pay the ransom or not. There are known trusted services to support with this endeavor if necessary.
